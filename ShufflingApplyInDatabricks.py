...
import socket
spark = SparkSession.builder.appName("ShuffleExecutorCoreTrace").master("local[4]").getOrCreate()   # Use 4 cores to simulate multiple executors.config("spark.sql.shuffle.partitions", "4") .getOrCreate()
